...
function myFunction(cityName) {
    ...
    fetch(
        'https://api.openweathermap.org/data/2.5/weather?q=' + cityName + '&units=imperial&appid=af23785a6adc1419c384f68b4a1ef8a7')
        ...
        .then(function (data) {
            ...
            fetch('https://api.openweathermap.org/data/2.5/uvi?lat=' + data.coord.lat + '&lon=' + data.coord.lon + '&units=imperial&appid=af23785a6adc1419c384f68b4a1ef8a7'
            )
                .then(function (response) {
                    return response.json();
                })
                .then(function (currentUvData) {
                    ...
                    fetch('https://api.openweathermap.org/data/2.5/onecall?lat=' + data.coord.lat + '&lon=' + data.coord.lon + '&exclude=hourly,minutely,alerts&units=imperial&appid=af23785a6adc1419c384f68b4a1ef8a7'
                    )
                        .then(function (response) {
                            return response.json();
                        })
